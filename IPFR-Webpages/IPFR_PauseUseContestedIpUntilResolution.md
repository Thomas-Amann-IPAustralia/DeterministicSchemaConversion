PageURL: "[https://ipfirstresponse.ipaustralia.gov.au/options/pause-use-contested-ip-until-resolution](https://ipfirstresponse.ipaustralia.gov.au/options/pause-use-contested-ip-until-resolution)"
...
For information about evaluating a cease and desist letter or a letter of demand, see: [Receiving a letter of demand | IP Australia First Response](https://ipfirstresponse.ipaustralia.gov.au/options/receiving-letter-demand).
...
* Can potentially de-escalate the situation and reduce the likelihood of expensive legal action or compensation claims – but often the other party will demand you do more than just stop using their IP. Other parties may still insist on other demands like you compensating them for your use of their IP up to the point where you stopped.
...
* **Loss of income or requirement to pay compensation** – If you’ve entered into IP licences or other contracts involving material or products that are alleged to infringe someone else's IP, you may lose expected payments such as licensing fees if you're required to stop using the material or product as agreed. Depending on the terms of those contracts, you may also be liable to pay compensation.
...
* [Avoid potential IP conflicts by rebranding | IP Australia First Response](https://ipfirstresponse.ipaustralia.gov.au/options/avoid-potential-ip-conflicts)
* [How To Respond To Accusations Of IP Infringement | IP Australia](https://www.ipaustralia.gov.au/manage-my-ip/how-to-respond-to-accusations-of-ip-infringement)
* [Find an IP attorney or firm | Trans-Tasman IP Attorneys Board](https://www.ttipattorney.gov.au/for-clients/how-to-engage-an-attorney/find-an-ip-attorney-or-firm?_gl=1*1a9t713*_ga*MTUwOTM4MDc5LjE3MzM3ODMxNTI.*_ga_GMT4KC15KS*MTczNjgyNzM1OS4yNy4xLjE3MzY4MjczNjkuMC4wLjA.)
