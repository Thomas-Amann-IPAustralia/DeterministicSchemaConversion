...
**For example,** a Melbourne café owner wanted to name their business “The Daily Grind”. A quick trade mark search revealed several similar registered marks in the food services class, prompting them to choose a different name before investing in signage and marketing.**2. Create original work**
...
**For example, **instead of copying a competitor’s product packaging, a small cosmetics company hired a graphic designer to develop distinct packaging that reflected their brand values while avoiding existing designs.**3. Understand what you can and cannot use**
