...
They can help parties access and navigate ADR processes. For more information about what ADR is, see IP First Response’s webpage available at: [General ADR Card](https://ipfirstresponse.ipaustralia.gov.au/options/ADR).

The WIPO Center’s tools and services include:

* Free information and procedural assistance services (sometimes called ‘[Good Offices](https://www.wipo.int/amc/en/goodoffices/) ‘) to facilitate or submit a dispute to WIPO’s ADR processes. This includes providing support throughout the parties’ engagement with the ADR options.
* An [extensive global database](https://www.wipo.int/amc/en/neutrals/index.html)  of mediators, arbitrators and experts, including from Australia. This includes experts from specific fields/specialties: [WIPO Alternative Dispute Resolution (ADR) Services for Specific Sectors](https://www.wipo.int/amc/en/center/specific-sectors/).
* Free [online case administration tools](https://www.wipo.int/amc/en/eadr/) that allow parties to manage and resolve disputes remotely.

ADR processes offered by the WIPO Centre include: 

* [Mediation](https://www.wipo.int/amc/en/mediation/index.html)
* [Arbitration](https://www.wipo.int/amc/en/arbitration/)
* [Expedited Arbitration](https://www.wipo.int/amc/en/arbitration/what-is-exp-arb.html)
* [Expert determination](https://www.wipo.int/amc/en/expert-determination/)

Your dispute doesn’t need to be international to use the WIPO Center, and other international dispute resolution services are available in some countries. For more information, see [IP First Response webpage on enforcing your IP overseas](https://ipfirstresponse.ipaustralia.gov.au/options/enforce-your-ip-overseas).
...
Information, procedural assistance, and use of the WIPO Center’s [Fee Calculator](https://amc.wipo.int/adr-fee-calculator/)  are free.
...
You can use the WIPO Center's [fee calculator](https://amc.wipo.int/adr-fee-calculator/)  and read the latest [fees and costs.](https://amc.wipo.int/adr-fee-calculator/)

[The WIPO Center offers a 25% reduction on its fees](https://www.wipo.int/amc/en/center/specific-sectors/smes/index.html)  when a small to medium enterprise (SME) is involved in a dispute. 
...
* Parties agree to resolve their dispute through the WIPO Center — However, the WIPO Center allows one party to initiate mediation by submitting [a unilateral request for mediation](https://www3.wipo.int/amc-forms/en/adr/unilateral-mediation).
* There is a contract in place whereby parties agree to resolve disputes through the WIPO Center. You might wish to consider including [ADR clauses in your contracts](https://www.wipo.int/amc/en/clauses/index.html)  in case you would like to resolve your future IP disputes with your business partners through ADR at the WIPO Center.
...
To receive information and procedural assistance from the WIPO Center, you can contact  [*arbiter.mail@wipo.int*](mailto:arbiter.mail@wipo.int) or file a Request for [Good Offices](https://www.wipo.int/amc/en/goodoffices/)  using the [WIPO Good Office](https://www.wipo.int/amc-forms/adr/good-offices-services)  Services 

If you are facing a dispute related to intellectual property, innovation, or technology, you can book a free online Orientation Session with the [WIPO Arbitration and Mediation Center](https://www.wipo.int/amc/en/index.html)  for assistance at: [How can WIPO assist in resolving intellectual property disputes?](https://www.wipo.int/amc/en/center/adr-assistance.html)

**Unilateral request for mediation**

If parties are already facing a dispute, and in the absence of a mediation agreement (for example in infringement disputes or in cases pending before the courts), a party may submit [a unilateral request for mediation](https://www3.wipo.int/amc-forms/en/adr/mediation)  to the WIPO Center, by e-mail to [arbiter.mail@wipo.int](mailto:arbiter.mail@wipo.int) or through the IP Portal.

The WIPO Center provides complimentary procedural assistance and ADR options at reduced fees for [SMEs](https://www.wipo.int/amc/en/center/specific-sectors/smes/index.html). Interested SMEs should contact the WIPO Center on (+65) 6225 2129 (Singapore), +4122 338 82 47 (Geneva) or [arbiter.mail@wipo.int](mailto:arbiter.mail@wipo.int) for further information.

##### **Getting advice**

You can also seek help from IP professionals to seek advice on whether the WIPO Center would be suitable for your situation and represent you throughout their ADR processes. You can find a qualified IP attorney to assist you at: [Find an IP attorney or firm | Trans-Tasman IP Attorneys Board](https://www.ttipattorney.gov.au/for-clients/how-to-engage-an-attorney/find-an-ip-attorney-or-firm?_gl=1*wp2lum*_ga*MTUwOTM4MDc5LjE3MzM3ODMxNTI.*_ga_GMT4KC15KS*MTczNjgxNTEyNS4yNS4xLjE3MzY4MTY5MDEuMC4wLjA.#als_iptags=Trade%20marks&als_e=0).

### See also

For more information on various types of ADR and features of each dispute resolution method, see:  

* [Your guide to dispute resolution](https://www.ag.gov.au/legal-system/publications/your-guide-dispute-resolution)  at Attorney-General’s Department website
* [Alternative Dispute Resolution](https://www.wipo.int/amc/en/)  [|](https://www.wipo.int/amc/en/)  [WIPO](https://www.wipo.int/amc/en/)
...
* [IP First Response Option Guide: Understanding alternative dispute resolution](https://ipfirstresponse.ipaustralia.gov.au/options/resolve-conflicts-help-experienced-facilitators)
* [IP First Response Option Guide: Mediation](https://ipfirstresponse.ipaustralia.gov.au/options/mediation)
* [IP First Response Option Guide: Arbitration](https://ipfirstresponse.ipaustralia.gov.au/options/arbitration)
