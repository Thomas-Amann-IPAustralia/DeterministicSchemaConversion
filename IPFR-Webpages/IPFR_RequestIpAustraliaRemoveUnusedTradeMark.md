...
|
|---|---|
You can file after ![]() | You can file after ![]() |
...
If the application to remove is opposed, the timing is similar to other [opposition processes](https://ipfirstresponse.ipaustralia.gov.au/options/challenge-registration-trade-mark) involving trade mark matters. The process typically takes at least 6-12 months, but can be much longer when hearings or subsequent appeals are involved.
...
The application for removal/cessation of protection for non-use must be filed in an approved form. Complete [this form ](https://www.ipaustralia.gov.au/tools-and-research/forms/application-for-removal-cessation-of-protection-for-non-use) when applying to have a registered trade mark removed from the register for non-use. This form is also used when applying for the cessation of protection of a protected international trade mark for non-use.

You can submit the completed form on the [Manage my IP page ](https://www.ipaustralia.gov.au/manage-my-ip/someone-is-using-my-ip/how-to-challenge-someone-elses-ip/opposition-hearings) of the IP Australia website.

## See also

[Remove a trade mark from the register (non-use) | IP Australia First Response](https://ipfirstresponse.ipaustralia.gov.au/options/trade-mark-non-use)[Application For Removal/cessation Of Protection For Non-use | IP Australia](https://www.ipaustralia.gov.au/tools-and-research/forms/application-for-removal-cessation-of-protection-for-non-use)[Opposition and objection fees | IP Australia](https://www.ipaustralia.gov.au/manage-my-ip/someone-is-using-my-ip/how-to-challenge-someone-elses-ip/opposition-and-objection-fees#fx-tabs-0-panel-0)[How to challenge someone else's IP | IP Australia](https://www.ipaustralia.gov.au/manage-my-ip/someone-is-using-my-ip/how-to-challenge-someone-elses-ip)[Find an IP attorney or firm | Trans-Tasman IP Attorneys Board](https://www.ttipattorney.gov.au/for-clients/how-to-engage-an-attorney/find-an-ip-attorney-or-firm?_gl=1*wp2lum*_ga*MTUwOTM4MDc5LjE3MzM3ODMxNTI.*_ga_GMT4KC15KS*MTczNjgxNTEyNS4yNS4xLjE3MzY4MTY5MDEuMC4wLjA.#als_iptags=Trade%20marks&als_e=0)
