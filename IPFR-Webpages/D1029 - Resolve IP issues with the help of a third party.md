PageURL: "[https://ipfirstresponse.ipaustralia.gov.au/options/arbitration](https://ipfirstresponse.ipaustralia.gov.au/options/arbitration)"
...
* Arbitral awards do not automatically set a *legal precedent*; the ruling of the arbitrator/s will apply to the parties to the dispute only.
...
1. Is there an existing contractual relationship between the parties which requires them (such as through an arbitration clause) to take disputes to a specific arbitral institution?
2. If not, is the other party likely to agree to take the dispute to an arbitrator or an arbitral institution?
3. Does the dispute concern a highly technical matter which would benefit from having a decision-maker with a high level of expertise in the specific sector or technology?
4. Is the subject matter of the dispute considered arbitrable in relevant jurisdictions? Though most areas of IP are considered arbitrable in many jurisdictions, questions relating to validity or registrability of intellectual property are deemed as non-arbitrable in some jurisdictions.
...
* [WIPO Schedule of Fees and Costs](https://www.wipo.int/amc/en/arbitration/fees/)
* [Australian Centre for International Commercial Arbitration](https://acica.org.au/)
