PageURL: "[https://ipfirstresponse.ipaustralia.gov.au/options/register-your-trade-mark](https://ipfirstresponse.ipaustralia.gov.au/options/register-your-trade-mark)"
...
Registering a trade mark through [TM Headstart](https://www.ipaustralia.gov.au/trade-marks/how-to-apply-for-a-trade-mark/pre-application-service-tm-headstart)  costs a minimum of $330. This covers submitting your pre-application (step 1), and finalising your application (step 3). If you need to make changes before finalising your application (step 2), this will add to your cost. 
...
|  | Addition of new classes (optional) | $200 |
...
 \
Your fees will be lower if you use the [picklist](https://tmgns.search.ipaustralia.gov.au/). The picklist is a searchable list of 100,000+ goods and services categorised into 45 classes relevant to trade marks. This helps examiners to know exactly which goods and services you intend to use the trade mark in relation to.  
...
There are over 800,000 registered trade marks on the [Australia Trade Mark Register.](https://search.ipaustralia.gov.au/trademarks/search/quick)   

### What do you need to proceed

You will need to set up an account with IP Australia's Online Services. There is a [step-by-step guide](https://www.ipaustralia.gov.au/trade-marks)  to applying for an Australian trade mark on our website. 

You don't need a lawyer to apply. However, if you would like support in making your application, you can contact an IP professional such as a registered trade mark attorney via [Find an IP attorney or firm | Trans-Tasman IP Attorneys Board](https://www.ttipattorney.gov.au/for-clients/how-to-engage-an-attorney/find-an-ip-attorney-or-firm?_gl=1*wp2lum*_ga*MTUwOTM4MDc5LjE3MzM3ODMxNTI.*_ga_GMT4KC15KS*MTczNjgxNTEyNS4yNS4xLjE3MzY4MTY5MDEuMC4wLjA.#als_iptags=Trade%20marks&als_e=0). IP professionals such as trade mark attorneys or IP lawyers can help you evaluate if applying for a trade mark is likely to resolve any current issues. 
...
Before applying, consider using TM Checker, a free online trade mark checking tool to check the registrability of your potential trade mark. TM Checker can be accessed here: [TM Checker](https://www.ipaustralia.gov.au/trade-marks/search-existing-trade-marks/tm-checker)    

### See also

* [Trade marks | IP Australia](https://www.ipaustralia.gov.au/trade-marks)
