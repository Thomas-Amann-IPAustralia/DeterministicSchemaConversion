PageURL: "[https://ipfirstresponse.ipaustralia.gov.au/options/check-if-someone-else-already-owns-word-logo-or-idea-you-want](https://ipfirstresponse.ipaustralia.gov.au/options/check-if-someone-else-already-owns-word-logo-or-idea-you-want)"

## Checking IP rights

# Check if someone else already owns a word, logo or idea you want
...
* [How to search existing trade marks | IP Australia](https://www.ipaustralia.gov.au/trade-marks/search-existing-trade-marks)
...
* [An Introduction to Copyright in Australia - ACC - INFO010 - Australian Copyright Council](https://www.copyright.org.au/browse/book/ACC-An-Introduction-to-Copyright-in-Australia-INFO010)
* [.au tools](https://www.auda.org.au/au-domain-names/au-tools/)  [| AUDA](https://www.auda.org.au/au-domain-names/au-tools/)
