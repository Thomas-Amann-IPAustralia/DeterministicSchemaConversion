...
- Informing customers that your product is protected (for example, stating 'patented', listing a trade mark registration number, using the ® symbol to indicate a
*trade mark*has been registered, or using a © symbol to indicate*copyright*material (although the symbol is not required in order for the material to be protected by copyright) - Equipping sales teams to explain the value and unique features of your genuine product.
